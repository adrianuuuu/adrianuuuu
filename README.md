      ...
      <td>
        <ul>
          ...
          <picture>
            ...
            <img align="right" width="400px" display="flex" justify-content="space-between" margin-right="30px" alt="GIF description" src="./Skills_Animation_White.gif">
          </picture>
 </table>
